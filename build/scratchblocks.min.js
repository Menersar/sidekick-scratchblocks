...
var scratchblocks = (function () {
  ...
  */
  ...
  const extensions = _objectSpread2(_objectSpread2({}, movedExtensions), {}, {
    tts: "tts",
    translate: "translate",
    microbit: "microbit",
    wedo: "wedo",
  ...
  class SVG {
    ...
    static text(x, y, content, props) {
      const text = SVG.el("text", _objectSpread2(_objectSpread2({}, props), {}, {
        x: x,
        y: y,
        textContent: content
      }));
  ...
  function init (window) {
     ...
     */
    const renderMatching = function renderMatching(selector, options) {
